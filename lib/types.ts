...
export type AOR = { name: string; uri: string; params?: Record<string, any>; };
export type Via = { version: string; protocol: string; host: string; port: string; };
...
export interface SrfRequest extends SipMessage {
  ...
  cancel(opts?: { headers?: Record<string, string> }, callback?: (err: any, req: SrfRequest) => void): void;
  on(event: 'response', callback: (res: SrfResponse, ack: (opts?: { body: string }) => void) => void): this;
